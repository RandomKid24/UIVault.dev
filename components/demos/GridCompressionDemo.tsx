...
const GridCompressionDemo = () => {
  ...
  const springVolume = useSpring(volume, { stiffness: 60, damping: 15 });
  ...
  const color = useTransform(springVolume, [0, 1], ["#222", "#06b6d4"]);
          ...
          {[...Array(24)].map((_, i) => (
            <motion.div
              ...
              style={{ 
                ...
                borderRadius,
                opacity: useTransform(springVolume, [0, 1], [0.2, 1])
              }}

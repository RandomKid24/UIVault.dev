      ...
      <div className="max-w-4xl mx-auto space-y-24 pb-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
          ...
          <div className="space-y-6">
            ...
            <p className="text-[10px] text-neutral-600 mono leading-relaxed uppercase">Uses mass-weighted springs to simulate kinetic overrun on data arrival.</p>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="relative h-12 w-full perspective-[1000px] flex items-center">
               {[0, 1, 2].map((i) => (
                 <motion.div
                   key={i}
                   animate={{ 
            ...
            <p className="text-[10px] text-neutral-600 mono leading-relaxed uppercase">A volumetric stack revealing progress across independent Z-plane strata.</p>
          </div>
          ...
          <div className="space-y-6">
            ...
            <p className="text-[10px] text-neutral-600 mono leading-relaxed uppercase">Represents data as a radiating photonic seed traveling through the system void.</p>
          </div>
          ...
          <div className="space-y-6">
            ...
            <p className="text-[10px] text-neutral-600 mono leading-relaxed uppercase">Information emerges from stochastic noise, stabilizing as signal gains strength.</p>
          </div>
        </div>

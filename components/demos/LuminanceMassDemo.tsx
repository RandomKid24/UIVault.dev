...
const LuminanceMassDemo = () => {
  const [magnitude, setMagnitude] = useState(0.5); // 0 to 1
  
  const springMagnitude = useSpring(magnitude, { stiffness: 50, damping: 20 });
  ...
  return (
    <div className="w-full h-full flex flex-col items-center justify-center bg-neutral-950 p-12 gap-20 overflow-hidden relative">
      <div className="text-center z-10 space-y-2">
        ...
        <p className="mono text-[10px] text-neutral-600 uppercase tracking-widest">Sensory_Load_Mapping</p>
      </div>
